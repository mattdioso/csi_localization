...
data_file = combined_dir + "/bedroom_augmented.npy"
data_mags_file = combined_dir + "/bedroom_mags_augmented.npy"
data_mags_norm_file = combined_dir + "/bedroom_mags_norm_augmented.npy"
