function alldata = extract_function(mat_file)
%load data.mat -ascii
%fullFileName = fullfile("../../datasets/mat_files", mat_file)
%data = load('-ascii', '../datasets/mat_files/1709/1709_6.7_3.6_2.5_9_4_nlos_8_trace.mat')
